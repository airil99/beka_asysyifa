                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Sunnah (Bekam Darah)</span>
                                                <span class="text-primary">RM80.00</span>
                                            </h5>
                                            <small class="fst-italic">24 Cup + Bekam Luncur + Urutan Guasha + Bekam Angin</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Sunnah & Migrain (2 in 1)</span>
                                                <span class="text-primary">RM100.00</span>
                                            </h5>
                                            <small class="fst-italic">29 Cup + Bekam Luncur + Urutan Guasha + Bekam Angin</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Overhall (Bekam Darah)</span>
                                                <span class="text-primary">RM130.00</span>
                                            </h5>
                                            <small class="fst-italic">35 Cup + Bekam Luncur + Urutan Guasha + Bekam Angin</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Kaki (Bekam Darah)</span>
                                                <span class="text-primary">RM80.00</span>
                                            </h5>
                                            <small class="fst-italic">24 Cup + Urutan Guasha + Bekam Angin</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Tangan (Bekam Darah)</span>
                                                <span class="text-primary">RM50.00</span>
                                            </h5>
                                            <small class="fst-italic">12 Cup + Bekam Angin</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Batin (Bekam Darah)</span>
                                                <span class="text-primary">RM50.00</span>
                                            </h5>
                                            <small class="fst-italic">12 Cup + Bekam Angin</small>
                                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Kering</span>
                                                <span class="text-primary">RM50.00</span>
                                            </h5>
                                            <small class="fst-italic">30 Cup + Urutan Guasha</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Bekam Muka (Bekam Darah)</span>
                                                <span class="text-primary">RM50.00</span>
                                            </h5>
                                            <small class="fst-italic">8 Cup + Bekam Angin</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Urut Tradisional Full Body</span>
                                                <span class="text-primary">RM90.00</span>
                                            </h5>
                                            <small class="fst-italic">1 Jam (Kecuali Batin)</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="w-100 d-flex flex-column text-start ps-4">
                                            <h5 class="d-flex justify-content-between border-bottom pb-2">
                                                <span>Urutan Peliaq Batin Lelaki</span>
                                                <span class="text-primary">RM85.00</span>
                                            </h5>
                                            <small class="fst-italic">30 minit</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
